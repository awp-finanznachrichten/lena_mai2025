#Welche Abstimmung?
abstimmung_date <- "Mai2025"
voting_date <- "2025-05-18"
date_voting <- "20250518"
...
FEED_CANTONAL <- "https://app-prod-static-voteinfo.s3.eu-central-1.amazonaws.com/v1/ogd/sd-t-17-02-20250518-kantAbstimmung.json"
